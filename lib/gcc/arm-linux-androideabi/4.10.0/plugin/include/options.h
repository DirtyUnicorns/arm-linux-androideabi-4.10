...
#endif
#ifdef GENERATOR_FILE
extern int flag_sanitize_recover;
#else
  int x_flag_sanitize_recover;
...
enum opt_code
{
  ...
  OPT_Wformat_signedness = 236,              /* -Wformat-signedness */
  ...
  OPT_Wshadow_ivar = 335,                    /* -Wshadow-ivar */
  ...
  OPT_fivar_visibility_ = 702,               /* -fivar-visibility= */
  ...
  OPT_flocal_ivars = 713,                    /* -flocal-ivars */
  OPT_floop_block = 714,                     /* -floop-block */
  /* OPT_floop_flatten = 715, */             /* -floop-flatten */
  OPT_floop_interchange = 716,               /* -floop-interchange */
  OPT_floop_nest_optimize = 717,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 718, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 719,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 720,                /* -floop-strip-mine */
  OPT_flto = 721,                            /* -flto */
  OPT_flto_compression_level_ = 722,         /* -flto-compression-level= */
  OPT_flto_partition_ = 723,                 /* -flto-partition= */
  ...
  OPT_frtti = 845,                           /* -frtti */
  OPT_fsanitize_recover = 846,               /* -fsanitize-recover */
  OPT_fsanitize_undefined_trap_on_error = 847,/* -fsanitize-undefined-trap-on-error */
  ...
  OPT_fuse_caller_save = 992,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 993,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 994,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 995,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 996,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 997,                    /* -fuse-ld=gold */
  OPT_fuse_ld_mcld = 998,                    /* -fuse-ld=mcld */
  ...
  OPT_mabi_ = 1071,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1072,             /* -mabort-on-noreturn */
  OPT_mandroid = 1073,                       /* -mandroid */
  OPT_mapcs = 1074,                          /* -mapcs */
  OPT_mapcs_float = 1075,                    /* -mapcs-float */
  OPT_mapcs_frame = 1076,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1077,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1078,              /* -mapcs-stack-check */
  OPT_march_ = 1079,                         /* -march= */
  OPT_marm = 1080,                           /* -marm */
  OPT_mbig_endian = 1081,                    /* -mbig-endian */
  OPT_mbionic = 1082,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1083,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1084,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1085,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1086,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1087,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1088,                  /* -mfp16-format= */
  OPT_mfpu_ = 1089,                          /* -mfpu= */
  OPT_mglibc = 1090,                         /* -mglibc */
  /* OPT_mhard_float = 1091, */              /* -mhard-float */
  OPT_mlittle_endian = 1092,                 /* -mlittle-endian */
  OPT_mlong_calls = 1093,                    /* -mlong-calls */
  OPT_mlra = 1094,                           /* -mlra */
  OPT_mneon_for_64bits = 1095,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1096,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1097,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1098,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1099,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1100,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1101,                   /* -mrestrict-it */
  OPT_msched_prolog = 1102,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1103,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1104,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1105, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1106,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1107,                         /* -mthumb */
  OPT_mthumb_interwork = 1108,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1109,                  /* -mtls-dialect= */
  OPT_mtp_ = 1110,                           /* -mtp= */
  OPT_mtpcs_frame = 1111,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1112,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1113,                         /* -mtune= */
  OPT_muclibc = 1114,                        /* -muclibc */
  OPT_munaligned_access = 1115,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1116,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1117,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1118,              /* -mword-relocations */
  OPT_mwords_little_endian = 1119,           /* -mwords-little-endian */
  OPT_n = 1120,                              /* -n */
  OPT_no_canonical_prefixes = 1121,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1122,              /* -no-integrated-cpp */
  OPT_nocpp = 1123,                          /* -nocpp */
  OPT_nodefaultlibs = 1124,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1125,                   /* -nostartfiles */
  OPT_nostdinc = 1126,                       /* -nostdinc */
  OPT_nostdinc__ = 1127,                     /* -nostdinc++ */
  OPT_nostdlib = 1128,                       /* -nostdlib */
  OPT_o = 1129,                              /* -o */
  OPT_p = 1130,                              /* -p */
  OPT_pass_exit_codes = 1131,                /* -pass-exit-codes */
  /* OPT_pedantic = 1132, */                 /* -pedantic */
  OPT_pedantic_errors = 1133,                /* -pedantic-errors */
  OPT_pg = 1134,                             /* -pg */
  OPT_pie = 1135,                            /* -pie */
  OPT_pipe = 1136,                           /* -pipe */
  OPT_posix = 1137,                          /* -posix */
  OPT_print_file_name_ = 1138,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1139,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1140,          /* -print-multi-directory */
  OPT_print_multi_lib = 1141,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1142,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1143,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1144,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1145,               /* -print-prog-name= */
  OPT_print_search_dirs = 1146,              /* -print-search-dirs */
  OPT_print_sysroot = 1147,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1148,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1149,                        /* -profile */
  OPT_pthread = 1150,                        /* -pthread */
  OPT_quiet = 1151,                          /* -quiet */
  OPT_r = 1152,                              /* -r */
  OPT_rdynamic = 1153,                       /* -rdynamic */
  OPT_remap = 1154,                          /* -remap */
  OPT_s = 1155,                              /* -s */
  OPT_s_bc_abi = 1156,                       /* -s-bc-abi */
  OPT_save_temps = 1157,                     /* -save-temps */
  OPT_save_temps_ = 1158,                    /* -save-temps= */
  OPT_shared = 1159,                         /* -shared */
  OPT_shared_libgcc = 1160,                  /* -shared-libgcc */
  /* OPT_specs = 1161, */                    /* -specs */
  OPT_specs_ = 1162,                         /* -specs= */
  OPT_static = 1163,                         /* -static */
  OPT_static_libasan = 1164,                 /* -static-libasan */
  OPT_static_libgcc = 1165,                  /* -static-libgcc */
  OPT_static_libgcj = 1166,                  /* -static-libgcj */
  OPT_static_libgfortran = 1167,             /* -static-libgfortran */
  OPT_static_libgo = 1168,                   /* -static-libgo */
  OPT_static_liblsan = 1169,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1170,               /* -static-libstdc++ */
  OPT_static_libtsan = 1171,                 /* -static-libtsan */
  OPT_static_libubsan = 1172,                /* -static-libubsan */
  /* OPT_std_c__03 = 1173, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1174, */                /* -std=c++0x */
  OPT_std_c__11 = 1175,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1176, */                /* -std=c++14 */
  ...
  /* OPT_std_gnu__14 = 1193, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1194,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1195,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1196,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1197, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1198, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1199,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1200,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1201, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1202, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1203,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1204, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1205, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1206, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1207,                     /* -std=legacy */
  OPT_symbolic = 1208,                       /* -symbolic */
  OPT_t = 1209,                              /* -t */
  OPT_time = 1210,                           /* -time */
  OPT_time_ = 1211,                          /* -time= */
  OPT_tno_android_cc = 1212,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1213,                 /* -tno-android-ld */
